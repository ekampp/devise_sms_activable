...
Add DeviseSmsAuthenticatable to your Gemfile (and Devise if you weren't using them):
  ...
  gem 'devise',           '>= 1.1.0'
  gem 'devise_sms_authenticatable', '~> 0.0.9'
...
DeviseSmsAuthenticatable extends your controllers with a <tt>require_sms_activated!</tt> method. Use it to restrict part of the site to "confirmed users" only
